# **CookMate** 🍳 [![GitHub stars](https://img.shields.io/github/stars/Sudip294/CookMate?style=social)](https://github.com/Sudip294/CookMate) [![License: MIT](https://img.shields.io/github/license/Sudip294/CookMate)](https://github.com/Sudip294/CookMate/blob/main/LICENSE)

> **Modern full-stack recipe discovery app** • React + Vite + Tailwind • Express + MongoDB • Spoonacular API • JWT Auth • Dark Mode

[![Screenshot](https://via.placeholder.com/1200x600/FF6B6B/FFFFFF?text=CookMate+Demo)](https://cookmate.vercel.app) *[Deployed Demo]*
